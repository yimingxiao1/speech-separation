...
# General config
# Task related
parser.add_argument('--train_dir', type=str, default='../tools/trainDataNewTwo/', #trainDataNewTwo trainData2_3  valDataNewFour
                    help='directory including mix.json, s1.json and s2.json')
parser.add_argument('--valid_dir', type=str, default='../tools/valDataNewTwo/', #valDataNewTwo/   valData2_3   valDataNewFour
                    help='directory including mix.json, s1.json and s2.json')
...
parser.add_argument('--batch_size', default=4, type=int, #48 #6
                    help='Batch size')
...
# save and load model
parser.add_argument('--save_folder', default='./ClustertrainTFSE1NewNoise',
...
# logging # '/media/xiao/xizo/home/Conv-TasNet-master/final.pth.tar',
